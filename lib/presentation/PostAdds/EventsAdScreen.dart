...
class EventsAdScreen extends StatefulWidget {
  const EventsAdScreen({super.key});

  @override
  State<EventsAdScreen> createState() => _EventsAdScreenState();
}

class _EventsAdScreenState extends State<EventsAdScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar1(title: 'Events Ad', actions: []),
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              CommonTextField1(
                lable: 'Enter Type of Event Name',
