    ...
    return Scaffold(
      ...
      bottomNavigationBar: SafeArea(
        child: Padding(
          ...
          child: BlocConsumer<MarkAsListingCubit, MarkAsListingState>(
              ...
              return BlocConsumer<BikesAdCubit, BikesAdStates>(
                ...
                builder: (context, state) {
                  return CustomAppButton1(
                    isLoading: state is BikesAdLoading ||
                    ...
                    onPlusTap: () {
                      if (_formKey.currentState?.validate() ?? false) {
                        ...
                        if (widget.editId
                            ...
                            .trim()
                            .isNotEmpty) {
                          context.read<MarkAsListingCubit>().markAsUpdate(
                            widget.editId,
                            data,
                          );
                        } else {
                          context.read<BikesAdCubit>().postBikeAd(data);
                        }
                      }
                    },
                  );
