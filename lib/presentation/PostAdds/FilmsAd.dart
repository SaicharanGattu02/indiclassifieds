...
class FilmsAdScreen extends StatefulWidget {
  const FilmsAdScreen({super.key});

  @override
  State<FilmsAdScreen> createState() => _FimlsAdScreenState();
}

class _FimlsAdScreenState extends State<FilmsAdScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar1(title: 'Films Ad', actions: []),
          ...
          child: Column(
            ...
            children: [
              ...
              CommonTextField1(
                ...
                hint: 'Example: sir Ramana films institute',
